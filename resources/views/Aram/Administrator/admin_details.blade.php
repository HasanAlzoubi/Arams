                                    ...
                                    <div class="card-body p-md-5" style="padding: 1rem !important;">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                                ...
                                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">بيانات مسؤول </p>

                                          <form class="mx-1 mx-md-4" method="post" action="{{asset(url('Administrator/update/'.$Admin->id))}}" enctype="multipart/form-data">
                                              ...
                                              @csrf
                                                    ...
                                                    <div class="d-flex flex-row align-items-center mb-4">
                                                        ...
                                                        <div class="form-outline flex-fill mb-0">
                                                            ...
                                                            <input class="form-control" value="{{$Admin->email}}" type="email" name="email" id="Email"   />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex flex-row align-items-center mb-4">
                                                        ...
                                                        <div class="form-outline flex-fill mb-0">
                                                            ...
                                                            <input type="password" name="password" id="pass-key" class="form-control"  />
                                                        </div>
                                              ...
                                              <div class="d-flex flex-row align-items-center mb-4">
                                                  ...
                                                  <div class="form-outline flex-fill mb-0">
                                                      ...
                                                      <input class="form-control" value="{{$Admin->mobile}}" type="number" name="mobile" id="Mobile"   />
                                                  </div>
                                              </div>
                                                    ...
                                                    <div class="d-flex flex-row align-items-center mb-4">
                                                        ...
                                                        <div class="form-outline flex-fill mb-0">
                                                            <label class="form-label" for="photo">تعديل صورة  </label>
                                            ...
                                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                                ...
                                                <img src="{{asset('Arams\images\Admin\\'.$Admin->photo)}}" style="width: 23em;  margin-right: 7em;margin-top: -9em;height: 21em;" class="img-fluid" alt="Sample image">
